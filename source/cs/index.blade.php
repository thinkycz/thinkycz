    ...
    <div class="max-w-4xl mx-auto px-6">
        <header class="flex justify-between items-center py-8">
            ...
            <div class="flex items-center space-x-4">
                <a href="https://www.linkedin.com/in/hailongdo" target="_blank" class="text-gray-500 hover:text-blue-600 transition-colors">
                ...
                <a href="https://github.com/thinkycz" target="_blank" class="text-gray-500 hover:text-gray-900 transition-colors">
                ...
                <a href="https://twitter.com/thinkycz" target="_blank" class="text-gray-500 hover:text-blue-400 transition-colors">
        ...
        <main class="py-12 md:py-20">
            <div class="md:flex justify-between items-center mb-24">
                ...
                <div class="md:w-1/3 hidden md:block">
                    <div class="relative">
                        <div class="absolute inset-0 bg-blue-100 rounded-full transform translate-x-4 translate-y-4"></div>
                        <img src="/assets/images/profile.jpg" alt="Profile" class="relative rounded-full w-full shadow-xl border-4 border-white object-cover aspect-square">
                    </div>
                </div>
            </div>
            ...
            <section>
                ...
                <div class="space-y-8">
                    <a href="https://nulisec.com" target="_blank" class="block group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
                        <div class="md:flex">
                            <div class="md:w-2/5 bg-blue-50">
                                <img class="w-full h-full object-cover" src="/assets/images/nulisec.jpg" alt="Nulisec">
                            </div>
                    ...
                    <a href="https://intermarketcompany.cz" target="_blank" class="block group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
                        <div class="md:flex flex-row-reverse">
                            <div class="md:w-2/5 bg-teal-50">
                                <img class="w-full h-full object-cover" src="/assets/images/skytrade.jpg" alt="Skytrade">
                            </div>
                            <div class="p-8 md:w-3/5 flex flex-col justify-center">
                    ...
                    <a href="https://mgns.cz" target="_blank" class="block group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
                        <div class="md:flex">
                            <div class="md:w-2/5 bg-green-50">
                                <img class="w-full h-full object-cover" src="/assets/images/magnus.jpg" alt="Magnus">
                            </div>
                            <div class="p-8 md:w-3/5 flex flex-col justify-center">
                    ...
                    <a href="http://hanzi.thinky.cz" target="_blank" class="block group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100">
                        <div class="md:flex flex-row-reverse">
                            <div class="md:w-2/5 bg-indigo-50">
                                <img class="w-full h-full object-cover" src="/assets/images/hanzi.jpg" alt="Hanzi">
                            </div>
                            <div class="p-8 md:w-3/5 flex flex-col justify-center">
